...
public class AuthController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "Usuario o empresa desactivados")
    })
    ...
    @Operation(summary = "Registrar nueva empresa", description = "Crea una nueva empresa con su usuario administrador")
    @ApiResponses(value = {
    ...
    public ResponseEntity<AuthResponse> register(@Valid @RequestBody RegisterRequest request) {
        log.info("POST /api/v1/auth/register - Empresa: {}, Email: {}", request.getNombreEmpresa(), request.getEmail());
